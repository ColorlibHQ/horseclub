...
function horseclub_import_files() {
	...
	$demoImg = '<img src="'. HORSECLUB_COMPANION_DIR_URL . 'inc/demo-data/screen-image.png" alt="'.esc_attr__( 'Demo Preview Imgae', 'horseclub' ).'" />';
  ...
  return array(
    array(
      ...
      'import_customizer_file_url'   => HORSECLUB_COMPANION_DIR_URL . 'inc/demo-data/horseclub-customizer.dat',
...
function horseclub_after_import_setup() {
	...
	$front_page_id = horseclub_get_page_by_title( 'Home' );
	$blog_page_id  = horseclub_get_page_by_title( 'Blog' );
...
function horseclub_demo_import_custom_scripts(){
	...
	if( isset( $_GET['page'] ) && $_GET['page'] == 'horseclub-demo-import' ){
		// style
		wp_enqueue_style( 'horseclub-demo-import', HORSECLUB_COMPANION_DIR_URL . 'inc/demo-data/css/demo-import.css', array(), '1.0', false );
	}
