    ...
    final class Horseclub_El_Widgets {
        ...
        public function enqueue_element_widgets_scripts() {
            ...
            /******************
                Enqueue Css
            ******************/
            wp_enqueue_style( 'owl-carousel', HORSECLUB_COMPANION_EL_URL  . 'assets/css/owl.carousel.css', array(), '1.0.0', 'all' );
            wp_enqueue_style( 'magnific-popup', HORSECLUB_COMPANION_EL_URL  . 'assets/css/magnific-popup.css', array(), '3.7.0', 'all' );
            wp_enqueue_style( 'justifiedGallery', HORSECLUB_COMPANION_EL_URL . 'assets/css/justifiedGallery.min.css', array(), '3.7.0', 'all' );
            ...
            ******************/
            ...
            // jquery waypoints js
            wp_enqueue_script( 'waypoints', HORSECLUB_COMPANION_EL_URL . 'assets/js/waypoints.min.js', array('jquery'), '1.0', true );

            // jquery counterup js
            wp_enqueue_script( 'jquery-counterup', HORSECLUB_COMPANION_EL_URL . 'assets/js/jquery.counterup.min.js', array('jquery'), '1.0', true );
            ...
            wp_enqueue_script( 'horseclub', HORSECLUB_COMPANION_EL_URL . 'assets/js/horseclub-companion-main.js', array( 'jquery', 'jquery-ui-datepicker' ), '1.0', true );
        ...
        public function register_widget_styles() {
            // Typing Effect
            wp_enqueue_style( 'horseclub-companion-elementor-edit', HORSECLUB_COMPANION_EL_URL . '/assets/css/elementor-edit.css' );
        }
