...
function horseclub_instagram_instance() {
...
// Blog Section
function horseclub_blog_section( $postnumber ) {
...
// 
function horseclub_section_heading( $title = '', $subtitle = '' ) {
    if( $title || $subtitle ):
    ?>
...
function horseclub_contact7_form_content( $template, $prop ) {
...
add_filter( 'wpcf7_default_template', 'horseclub_contact7_form_content', 10, 2 );
